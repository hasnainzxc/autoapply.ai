...
import {
  ...
  Loader2, TrendingUp, Star, Shield, Award, Users, Briefcase
} from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="max-w-2xl">
            ...
            <h1 className="hero-headline text-black mb-6 animate-liquid-in">
              Land your dream job,{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-black/60 to-black/40">
                faster.
              </span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4 animate-liquid-in animation-delay-300">
              ...
              <Button size="xl" variant="pillOutline">
                View Demo
              </Button>
            </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 animate-fade-up">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">
            Everything you need to <span className="text-cyber-yellow">win</span>
          </h2>
          <p className="text-zinc-400 text-lg max-w-xl mx-auto body-text">
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12">
          {steps.map((item, i) => (
            <div key={i} className="relative text-center md:text-left group">
              ...
              {i < 2 && (
                <div className="hidden md:block absolute top-10 -right-8 lg:-right-16 w-16 lg:w-32 h-px bg-gradient-to-r from-cyber-yellow/50 to-transparent" />
              )}
            </div>
          ))}
        </div>
          ...
          {testimonials.map((t, i) => (
            <GlassCard key={i} className="p-8" variant="floating">
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-cyber-yellow flex items-center justify-center text-black font-bold text-sm">
                  {t.avatar}
                </div>
                <div>
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20 opacity-40">
          {partners.map((partner, i) => (
            <span key={i} className="text-2xl font-bold text-white tracking-wider">{partner.toUpperCase()}</span>
          ))}
        </div>
      </div>
    </section>
    ...
    <section className="py-32 px-6 bg-onyx relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative">
        <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-8 tracking-tight">
          Ready to land your <span className="text-cyber-yellow">dream job?</span>
        </h2>
    ...
    <footer className="py-12 px-6 bg-black border-t border-white/10">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-cyber-yellow flex items-center justify-center">
...
function GetStartedSection({ onStart }: { onStart: () => void }) {
  return (
    <section id="get-started" className="py-24 px-6 bg-cyber-yellow relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative">
        ...
        <p className="text-black/70 text-lg mb-10">
          Paste any job URL and let our AI handle the rest.
        </p>
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 px-4">
              <input
                ...
                className="w-full bg-transparent text-white placeholder:text-zinc-500 focus:outline-none text-lg py-4"
              />
            </div>
    ...
    <div className="min-h-screen bg-onyx">
      {step === "landing" ? (
        <>
          ...
          <LiquidHero />
          <GetStartedSection onStart={handleStart} />
          <FeaturesSection />
          <TrustBadges />
          <HowItWorks />
          <TestimonialsSection />
        ...
        <main className="max-w-2xl mx-auto px-8 pt-32 pb-20">
            ...
            <div className="animate-scale-in">
              <div className="text-center mb-10">
                <h2 className="text-3xl font-bold text-white mb-3">
                  Choose your <span className="text-cyber-yellow">template</span>
                </h2>
                  ...
                  <button
                    ...
                    className={`w-full p-5 rounded-2xl text-left transition-all duration-300 border ${
                      selectedTemplate === template.id
                        ? "border-cyber-yellow bg-cyber-yellow/10 shadow-[0_0_30px_-10px_rgba(253,224,71,0.3)]"
          ...
          {step === "processing" && (
            <div className="text-center py-12 animate-fade-up">
              <div className="relative w-28 h-28 mx-auto mb-8">
                ...
                <div className="relative w-28 h-28 rounded-full bg-cyber-yellow flex items-center justify-center shadow-xl">
                ...
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-white/5">
                    {item.done ? (
                      ...
                      <Loader2 className="w-5 h-5 text-cyber-yellow animate-spin" />
                    )}
          ...
          {step === "complete" && (
            <div className="text-center py-12 animate-scale-in">
              <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-cyber-yellow flex items-center justify-center shadow-[0_0_40px_-10px_rgba(253,224,71,0.5)]">
