...
import { Zap, ChevronRight, X, Home, FileText, Briefcase, Send, CreditCard } from "lucide-react";
    ...
    <>
          ...
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <button
                ...
                className="lg:hidden w-10 h-10 flex items-center justify-center rounded-xl text-[#E4E2DD] hover:bg-white/[0.06] transition-colors"
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-[60] lg:hidden">
          ...
          {/* Drawer */}
          <div className="absolute top-0 right-0 bottom-0 w-[300px] max-w-[85vw] bg-[#0C0C0C] border-l border-white/[0.08] flex flex-col">
            {/* Header */}
